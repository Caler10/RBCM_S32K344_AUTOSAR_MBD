...
Backend* Backend::m_instance = NULL;
//-----------------------------------------------------------------------------
...
bool Backend::saveFile(QString path, const QString& data)
{
...
QString Backend::importFile(QString path)
{
#ifdef Q_OS_WINDOWS
...
bool Backend::copyFile(QString path, QString newPath)
{
#ifdef Q_OS_WINDOWS
    path = path.remove("file:///").remove("qrc");
#else
