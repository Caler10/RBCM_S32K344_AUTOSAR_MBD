...
import Qt.labs.platform 1.1 //labs里的库要自己单独打包到exe里
import Qt.labs.settings 1.0 //labs里的库要自己单独打包到exe里（D:\AppGallery\Software\Qt\6.5.7\mingw_64\qml\Qt\labs复制粘贴到<程序目录>\qml\Qt\labs）

Frameless {
    id: rootWindow

    property string titleStr: "WUTE-MQTT-DashBoard"
    property var areas: [
