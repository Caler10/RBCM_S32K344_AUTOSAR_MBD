...
==================================================================================================*/
#define SCHM_MEM_43_EXFLS_AR_RELEASE_MAJOR_VERSION_C     4
#define SCHM_MEM_43_EXFLS_AR_RELEASE_MINOR_VERSION_C     7
#define SCHM_MEM_43_EXFLS_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_MEM_43_EXFLS_SW_MAJOR_VERSION_C             4
...
#ifdef MCAL_PLATFORM_S12
    #define Mem_43_EXFLS_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define Mem_43_EXFLS_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
...
void SchM_Exit_Mem_43_EXFLS_MEM_EXCLUSIVE_AREA_10(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
