...
==================================================================================================*/
#define SCHM_CANTRCV_43_AE_AR_RELEASE_MAJOR_VERSION_C     4
#define SCHM_CANTRCV_43_AE_AR_RELEASE_MINOR_VERSION_C     7
#define SCHM_CANTRCV_43_AE_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_CANTRCV_43_AE_SW_MAJOR_VERSION_C             4
#define SCHM_CANTRCV_43_AE_SW_MINOR_VERSION_C             0
#define SCHM_CANTRCV_43_AE_SW_PATCH_VERSION_C             0
...
* 
*/
uint32 CanTrcv_43_AE_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 CanTrcv_43_AE_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#elif  (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
...
#ifdef MCAL_PLATFORM_S12
    #define CanTrcv_43_AE_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define CanTrcv_43_AE_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
...
@remarks Implements 
*/
void SchM_Check_cantrcv_43_ae(void)
{
    EU_ASSERT(TRUE);
}
