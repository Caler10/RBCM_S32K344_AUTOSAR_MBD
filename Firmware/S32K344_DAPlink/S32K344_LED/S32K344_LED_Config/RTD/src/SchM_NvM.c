...
*   SW Version           : 4.0.0
*   Build Version        : S32K3_RTD_4_0_0_P04_D2312_ASR_REL_4_7_REV_0000_20231220
*
...
==================================================================================================*/
#define SCHM_NVM_AR_RELEASE_MAJOR_VERSION_C     4
#define SCHM_NVM_AR_RELEASE_MINOR_VERSION_C     7
#define SCHM_NVM_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_NVM_SW_MAJOR_VERSION_C             4
#define SCHM_NVM_SW_MINOR_VERSION_C             0
#define SCHM_NVM_SW_PATCH_VERSION_C             0
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 Nvm_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#elif  (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
...
#ifdef MCAL_PLATFORM_S12
    #define Nvm_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define Nvm_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
