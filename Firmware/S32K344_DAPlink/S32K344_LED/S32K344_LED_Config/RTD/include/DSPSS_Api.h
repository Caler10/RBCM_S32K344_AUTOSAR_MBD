...
#define DSPSS_SW_MAJOR_VERSION_API               4
 ...
 *
 * @param[in] ContrlMode Controlling mode of thread scheduling.
 * @param[in] SchdSeq1 First thread that will be scheduled in clock threshold mode.
 * @param[in] SchdSeq2 Second thread that will be scheduled in clock threshold mode.
 * @param[in] SchdSeq3 Third thread that will be scheduled in clock threshold mode.
 * @param[in] SchdSeq4 Fourth thread that will be scheduled in clock threshold mode.
 * @return void
 */
