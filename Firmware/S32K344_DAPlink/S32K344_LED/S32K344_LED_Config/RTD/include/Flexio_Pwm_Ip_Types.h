...
#define FLEXIO_PWM_IP_TYPES_SW_MAJOR_VERSION             4
...
/**
 * @brief       Clock source selection for counter.
 * @details     This enumeration specifies the clock divider value for the timer counter decrement.
 *
 * @internal
 */
typedef enum
{
    ...
    FLEXIO_PWM_IP_CLK_DIV_1     = 0U,
    /* Decrement counter on Flexio clock divided by 16 */
    FLEXIO_PWM_IP_CLK_DIV_16    = 4U,
    /* Decrement counter on Flexio clock divided by 256 */
    FLEXIO_PWM_IP_CLK_DIV_256   = 5U
} Flexio_Pwm_Ip_ClockPrescalerType;
#endif
...
typedef struct
{
    ...
    uint8 PinId;
#if (defined(FLEXIO_PWM_IP_HAS_PRESCALER) && (FLEXIO_PWM_IP_HAS_PRESCALER == STD_ON))
    /** @brief Counter decrement clock prescaler */
