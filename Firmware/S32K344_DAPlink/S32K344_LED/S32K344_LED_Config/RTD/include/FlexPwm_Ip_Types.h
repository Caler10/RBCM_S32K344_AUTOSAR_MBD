...
#define FLEXPWM_IP_TYPES_SW_MAJOR_VERSION                      4
...
typedef struct
{
    ...
    uint16  MaskOutput;                 /*!< Mask the channel outputs of each instance. */
    uint8   MasterControlRun;           /*!< Enables the clocks to the PWM generator in each instance */
