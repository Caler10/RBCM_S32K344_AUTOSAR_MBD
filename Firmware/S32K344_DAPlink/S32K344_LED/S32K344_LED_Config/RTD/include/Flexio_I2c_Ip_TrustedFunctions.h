...
#define FLEXIO_I2C_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION                4
...
* @return           void.
*/
extern void Flexio_I2c_Ip_MasterEndDmaTransfer(uint8 Instance,
                                               uint8 Channel,
                                               boolean Receive);
...
* @return           void.
*/
extern void Flexio_I2c_Ip_MasterDmaTransferErrorHandler(uint8 Instance,
                                                        uint8 Channel);
#endif
#endif
