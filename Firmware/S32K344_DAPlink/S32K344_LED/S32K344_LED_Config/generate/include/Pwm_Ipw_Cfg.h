...
#define PWM_FAST_UPDATE_API                     (STD_ON)
...
/** @brief       Switch to indicate that platform-specific validation of the Pwm_GetOutputState is supported */
#define PWM_GETOUTPUTSTATE_PLAUSABILITY         (STD_ON)
