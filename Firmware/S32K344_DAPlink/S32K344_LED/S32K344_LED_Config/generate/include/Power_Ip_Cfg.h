...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Power_Ip_Cfg.h file and Power_Ip_MBDT_PBcfg.h file are of the same vendor */
#if (POWER_IP_CFG_VENDOR_ID != POWER_IP_PBCFG_VENDOR_ID)
    #error "Power_Ip_Cfg.h and Power_Ip_MBDT_PBcfg.h have different vendor ids"
#endif

/* Check if Power_Ip_Cfg.h file and Power_Ip_MBDT_PBcfg.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Power_Ip_Cfg.h and Power_Ip_MBDT_PBcfg.h are different"
#endif

/* Check if Power_Ip_Cfg.h file and Power_Ip_MBDT_PBcfg.h file are of the same Software version */
  ...
  #error "Software Version Numbers of Power_Ip_Cfg.h and Power_Ip_MBDT_PBcfg.h are different"
#endif
