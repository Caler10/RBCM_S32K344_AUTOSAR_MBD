...
/**
* @brief          Symbolic name for the channel CanController_0_EN.
*
*/
#define DioConf_DioChannel_CanController_0_EN  ((uint16)0x0055U)
/**
* @brief          Symbolic name for the channel CanController_0_ERRN.
*
*/
#define DioConf_DioChannel_CanController_0_ERRN  ((uint16)0x0057U)
/**
* @brief          Symbolic name for the channel CanController_0_STB.
*
*/
#define DioConf_DioChannel_CanController_0_STB  ((uint16)0x0054U)
/**
* @brief          Symbolic name for the channel PTC30.
*
*/
#define DioConf_DioChannel_PTC30  ((uint16)0x005eU)
/* ---------- PTD_L ---------- */
...
/**
* @brief          Symbolic name for the channel MYLED.
*
*/
#define DioConf_DioChannel_MYLED  ((uint16)0x002eU)
