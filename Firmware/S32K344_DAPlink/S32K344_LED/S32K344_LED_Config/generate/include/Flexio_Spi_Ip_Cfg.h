...
#include "Mcal.h"
#include "OsIf.h"
#include "Flexio_Spi_Ip_MBDT_PBcfg.h"
...
#define FLEXIO_SPI_IP_SW_MAJOR_VERSION_CFG                4
...
/* Check if Flexio_Spi_Ip_MBDT_PBcfg header file and Spi configuration header file are of the same vendor */
#if (FLEXIO_SPI_IP_MBDT_VENDOR_ID_PBCFG != FLEXIO_SPI_IP_VENDOR_ID_CFG)
    #error "Flexio_Spi_Ip_MBDT_PBcfg.h and FLEXIO_SPI_IP_Cfg.h have different vendor IDs"
#endif
    /* Check if Flexio_Spi_Ip_MBDT_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((FLEXIO_SPI_IP_MBDT_AR_RELEASE_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_MBDT_AR_RELEASE_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_MBDT_AR_RELEASE_REVISION_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_REVISION_VERSION_CFG))
    #error "AutoSar Version Numbers of Flexio_Spi_Ip_MBDT_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
/* Check if Flexio_Spi_Ip_MBDT_PBcfg header file and Spi configuration header file are of the same software version */
#if ((FLEXIO_SPI_IP_MBDT_SW_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_MBDT_SW_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_MBDT_SW_PATCH_VERSION_PBCFG != FLEXIO_SPI_IP_SW_PATCH_VERSION_CFG))
    #error "Software Version Numbers of Flexio_Spi_Ip_MBDT_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
/*==================================================================================================
                                            CONSTANTS
==================================================================================================*/
...
#define FLEXIO_SPI_IP_NUMBER_OF_HWUNIT_U8           (uint8)(4U)

/** @brief Total number of Flexio instance. */
#define FLEXIO_SPI_IP_INSTANCE_COUNT           (FLEXIO_INSTANCE_COUNT)

/** @brief HWUnits enabled/disabled and Slave supported */
...
#define FLEXIO_SPI_IP_ENABLE_USER_MODE_SUPPORT           STD_OFF
  ...
  #endif /* (STD_ON == FLEXIO_SPI_IP_ENABLE_USER_MODE_SUPPORT) */
...
*/
#define FLEXIO_SPI_IP_REG_PROT_AVAILABLE   (STD_OFF)

#if (STD_ON == FLEXIO_SPI_IP_REG_PROT_AVAILABLE)
/**
* @brief The protection size
*/
    #define FLEXIO_SPI_IP_PROT_MEM_U32                           ((uint32)4U)
#endif
/**
...
*/
#define FLEXIO_SPI_IP_FRAMESIZE_MIN_U8                              ((uint8)1U)
...
#define FLEXIO_SPI_IP_TIMCFG_DEFAULT_SLAVE_CPHA0_VALUE_U32         ((uint32) 0x01200600u)
#define FLEXIO_SPI_IP_TIMCFG_DEFAULT_SLAVE_CPHA1_VALUE_U32         ((uint32) 0x01206602u)
