...
#define ICU_CFG_SW_MAJOR_VERSION                4
...
#if (ICU_MBDT_PBCFG_VENDOR_ID != ICU_CFG_VENDOR_ID)
    #error "Icu_MBDT_PBcfg.h and Icu_Cfg.h have different vendor IDs"
#endif
/* Check if header file and Icu configuration header file are of the same Autosar version */
#if ((ICU_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION != ICU_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (ICU_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION != ICU_CFG_AR_RELEASE_MINOR_VERSION) || \
     (ICU_MBDT_PBCFG_AR_RELEASE_REVISION_VERSION != ICU_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Icu_MBDT_PBcfg.h and Icu_Cfg.h are different"
#endif
/* Check if header file and Icu configuration header file are of the same software version */
#if ((ICU_MBDT_PBCFG_SW_MAJOR_VERSION != ICU_CFG_SW_MAJOR_VERSION) || \
     (ICU_MBDT_PBCFG_SW_MINOR_VERSION != ICU_CFG_SW_MINOR_VERSION) || \
     (ICU_MBDT_PBCFG_SW_PATCH_VERSION != ICU_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of Icu_MBDT_PBcfg.h and Icu_Cfg.h are different"
#endif
...
#define ICU_MAX_CHANNEL                 ((Icu_ChannelType)4U)
...
/**
 * @brief  Adds or removes the service set Default Counter for eMios.
 *         STD_ON:  Enabled.
 *         STD_OFF: Disabled.
 */
...
/**
 * @brief  Adds or removes the service set Offset Counter for eMios.
 *         STD_ON:  Enabled.
 *         STD_OFF: Disabled.
 */
