...
#include "Tspc_Port_Ip_MBDT_PBcfg.h"
/*==================================================================================================
...
#define TSPC_PORT_IP_SW_MAJOR_VERSION_CFG_H                4
...
/* Check if the files Tspc_Port_Ip_Cfg.h and Tspc_Port_Ip_MBDT_PBcfg.h are of the same version */
#if (TSPC_PORT_IP_VENDOR_ID_CFG_H != TSPC_PORT_IP_VENDOR_ID_MBDT_PBCFG_H)
    #error "Tspc_Port_Ip_Cfg.h and Tspc_Port_Ip_MBDT_PBcfg.h have different vendor IDs"
#endif
/* Check if the files Tspc_Port_Ip_Cfg.h and Tspc_Port_Ip_MBDT_PBcfg.h are of the same Autosar version */
#if ((TSPC_PORT_IP_AR_RELEASE_MAJOR_VERSION_CFG_H != TSPC_PORT_IP_AR_RELEASE_MAJOR_VERSION_MBDT_PBCFG_H) ||   \
     (TSPC_PORT_IP_AR_RELEASE_MINOR_VERSION_CFG_H != TSPC_PORT_IP_AR_RELEASE_MINOR_VERSION_MBDT_PBCFG_H) ||   \
     (TSPC_PORT_IP_AR_RELEASE_REVISION_VERSION_CFG_H != TSPC_PORT_IP_AR_RELEASE_REVISION_VERSION_MBDT_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of Tspc_Port_Ip_Cfg.h and Tspc_Port_Ip_MBDT_PBcfg.h are different"
#endif
/* Check if the files Tspc_Port_Ip_Cfg.h and Tspc_Port_Ip_MBDT_PBcfg.h are of the same software version */
#if ((TSPC_PORT_IP_SW_MAJOR_VERSION_CFG_H != TSPC_PORT_IP_SW_MAJOR_VERSION_MBDT_PBCFG_H) || \
     (TSPC_PORT_IP_SW_MINOR_VERSION_CFG_H != TSPC_PORT_IP_SW_MINOR_VERSION_MBDT_PBCFG_H) || \
     (TSPC_PORT_IP_SW_PATCH_VERSION_CFG_H != TSPC_PORT_IP_SW_PATCH_VERSION_MBDT_PBCFG_H)     \
    )
    #error "Software Version Numbers of Tspc_Port_Ip_Cfg.h and Tspc_Port_Ip_MBDT_PBcfg.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
