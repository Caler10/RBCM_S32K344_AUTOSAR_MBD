...
#define GPT_SW_MAJOR_VERSION_MBDT_PBCFG_C               4
...
#if (GPT_VENDOR_ID_MBDT_PBCFG_C != GPT_IPW_VENDOR_ID_MBDT_PBCFG_H)
    #error "Gpt_MBDT_PBcfg.c and Gpt_Ipw_MBDT_PBcfg.h have different vendor ids"
#endif
/* Check if the header files are of the same Autosar version */
#if ((GPT_AR_RELEASE_MAJOR_VERSION_MBDT_PBCFG_C != GPT_IPW_AR_RELEASE_MAJOR_VERSION_MBDT_PBCFG_H) || \
     (GPT_AR_RELEASE_MINOR_VERSION_MBDT_PBCFG_C != GPT_IPW_AR_RELEASE_MINOR_VERSION_MBDT_PBCFG_H) || \
     (GPT_AR_RELEASE_REVISION_VERSION_MBDT_PBCFG_C != GPT_IPW_AR_RELEASE_REVISION_VERSION_MBDT_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of Gpt_MBDT_PBcfg.c and Gpt_Ipw_MBDT_PBcfg.h are different"
#endif
/* Check if the header files are of the same Software version */
#if ((GPT_SW_MAJOR_VERSION_MBDT_PBCFG_C != GPT_IPW_SW_MAJOR_VERSION_MBDT_PBCFG_H) || \
     (GPT_SW_MINOR_VERSION_MBDT_PBCFG_C != GPT_IPW_SW_MINOR_VERSION_MBDT_PBCFG_H) || \
     (GPT_SW_PATCH_VERSION_MBDT_PBCFG_C != GPT_IPW_SW_PATCH_VERSION_MBDT_PBCFG_H)    \
    )
    #error "Software Version Numbers of Gpt_MBDT_PBcfg.c and Gpt_Ipw_MBDT_PBcfg.h. are different"
#endif
