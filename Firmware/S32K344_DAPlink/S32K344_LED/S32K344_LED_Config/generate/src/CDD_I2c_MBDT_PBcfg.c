...
==================================================================================================*/
#define I2C_MBDT_PBCFG_VENDOR_ID_C                     43
#define I2C_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION_C      4
#define I2C_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION_C      7
#define I2C_MBDT_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define I2C_MBDT_PBCFG_SW_MAJOR_VERSION_C              4
#define I2C_MBDT_PBCFG_SW_MINOR_VERSION_C              0
#define I2C_MBDT_PBCFG_SW_PATCH_VERSION_C              0

/*==================================================================================================
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and I2c header file are of the same vendor */
#if (I2C_MBDT_PBCFG_VENDOR_ID_C != I2C_VENDOR_ID)
    #error "I2c_MBDT_PBcfg.c and CDD_I2c.h have different vendor ids"
#endif
/* Check if current file and I2c header file are of the same Autosar version */
#if ((I2C_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION_C != I2C_AR_RELEASE_MAJOR_VERSION) || \
     (I2C_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION_C != I2C_AR_RELEASE_MINOR_VERSION) || \
     (I2C_MBDT_PBCFG_AR_RELEASE_REVISION_VERSION_C != I2C_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of I2c_MBDT_PBcfg.c and CDD_I2c.h are different"
#endif
/* Check if current file and I2c header file are of the same Software version */
#if ((I2C_MBDT_PBCFG_SW_MAJOR_VERSION_C != I2C_SW_MAJOR_VERSION) || \
     (I2C_MBDT_PBCFG_SW_MINOR_VERSION_C != I2C_SW_MINOR_VERSION) || \
     (I2C_MBDT_PBCFG_SW_PATCH_VERSION_C != I2C_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of I2c_MBDT_PBcfg.c and CDD_I2c.h are different"
#endif

/* Check if current file and DEM header file are of the same version */
#if (I2C_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((I2C_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION_C != DEM_AR_RELEASE_MAJOR_VERSION) || \
         (I2C_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION_C != DEM_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of I2c_MBDT_PBcfg.c and Dem.h are different"
    #endif
#endif
#endif
