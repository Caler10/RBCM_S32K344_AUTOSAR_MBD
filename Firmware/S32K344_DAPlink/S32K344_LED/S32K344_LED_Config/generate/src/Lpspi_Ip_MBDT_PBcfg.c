...
#define LPSPI_IP_MBDT_SW_MAJOR_VERSION_PBCFG_C                 4
...
#error "Software Version Numbers of Lpspi_Ip.h and Lpspi_Ip_MBDT_PBcfg.c are different"
        ...
        #if ((DMA_IP_AR_RELEASE_MAJOR_VERSION != LPSPI_IP_MBDT_AR_RELEASE_MAJOR_VERSION_PBCFG_C) || \
             (DMA_IP_AR_RELEASE_MINOR_VERSION != LPSPI_IP_MBDT_AR_RELEASE_MINOR_VERSION_PBCFG_C))
        #error "AutoSar Version Numbers of Lpspi_Ip_MBDT_PBcfg.c and Dma_Ip.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
