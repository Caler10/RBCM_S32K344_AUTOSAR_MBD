...
==================================================================================================*/
#define LCU_IP_MBDT_PBCFG_MODULE_ID_C                        255
...
#define LCU_IP_MBDT_PBCFG_SW_MAJOR_VERSION_C                 4
...
const Lcu_Ip_LogicInstanceType LcuLogicInstance0ConfigPB_MBDT =
{
...
const Lcu_Ip_LogicInstanceType * const Lcu_Ip_ppxLogicInstanceArrayPB_MBDT[LCU_IP_NOF_CFG_LOGIC_INSTANCES] =
{
...
const Lcu_Ip_LogicInputConfigType LogicInput0CfgPB_MBDT =
{
...
const Lcu_Ip_LogicInputType LogicInput0PB_MBDT =
{
    {
        /* uint8 HwInstId      */ LCU_IP_HW_INST_0,
...
const Lcu_Ip_LogicInputType * const Lcu_Ip_ppxLogicInputArrayPB_MBDT[LCU_IP_NOF_CFG_LOGIC_INPUTS] =
{
    &LogicInput0PB_MBDT,
};
...
/* @violates @ref LCU_IP_PBCFG_C_REF_1 MISRA 2012 Required Directive 4.10, Precautions shall be taken in order to prevent the contents of a header file being included more than once. */
#include "Mcl_MemMap.h"
Lcu_Ip_HwOutputStateType HwOutput0StatePB_MBDT;
...
/* @violates @ref LCU_IP_PBCFG_C_REF_1 MISRA 2012 Required Directive 4.10, Precautions shall be taken in order to prevent the contents of a header file being included more than once. */
#include "Mcl_MemMap.h"
Lcu_Ip_HwOutputStateType * Lcu_Ip_ppxHwOutputStateArrayPB_MBDT[LCU_IP_NOF_CFG_LOGIC_OUTPUTS] =
{
...
const Lcu_Ip_LogicOutputConfigType LogicOutput0CfgPB_MBDT =
{
...
const Lcu_Ip_LogicOutputType LogicOutput0PB_MBDT =
{
    {
        /* uint8 HwInstId               */ LCU_IP_HW_INST_0,
...
const Lcu_Ip_LogicOutputType * const Lcu_Ip_ppxLogicOutputArrayPB_MBDT[LCU_IP_NOF_CFG_LOGIC_OUTPUTS] =
{
    &LogicOutput0PB_MBDT,
};
