...
#define BCTU_IP_SW_MAJOR_VERSION_MBDT_PBCFG_C               4
...
const Bctu_Ip_ConfigType BctuIpConfigControlMode_0_MBDT =
{
    ...
    { { NULL_PTR, NULL_PTR, NULL_PTR }, { Adc1_CtuNewDataNotification, Adc1_CtuDataOverrunNotification, Adc1_CtuListLastNotification }, { Adc2_CtuNewDataNotification, Adc2_CtuDataOverrunNotification, Adc2_ListLastNotification } }, /* AdcNotifications */
    3U, /* NumTrigConfigs */
