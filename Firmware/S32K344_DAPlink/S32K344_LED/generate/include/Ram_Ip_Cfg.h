...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Ram_Ip_Cfg.h file and Ram_Ip_MBDT_PBcfg.h file are of the same vendor */
#if (RAM_IP_CFG_VENDOR_ID != RAM_IP_PBCFG_VENDOR_ID)
    #error "Ram_Ip_Cfg.h and Ram_Ip_MBDT_PBcfg.h have different vendor ids"
#endif

/* Check if Ram_Ip_Cfg.h file and Ram_Ip_MBDT_PBcfg.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Ram_Ip_Cfg.h and Ram_Ip_MBDT_PBcfg.h are different"
#endif

/* Check if Ram_Ip_Cfg.h file and Ram_Ip_MBDT_PBcfg.h file are of the same Software version */
  ...
  #error "Software Version Numbers of Ram_Ip_Cfg.h and Ram_Ip_MBDT_PBcfg.h are different"
#endif
