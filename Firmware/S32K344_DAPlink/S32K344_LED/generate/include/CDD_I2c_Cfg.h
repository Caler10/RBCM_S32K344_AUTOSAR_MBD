...
/* Check if current file and CDD_I2c_MBDT_PBcfg.h header file are of the same module */
#if (I2C_MODULE_ID_CFG != I2C_MBDT_PBCFG_MODULE_ID)
    #error "CDD_I2c_Cfg.h and CDD_I2c_MBDT_PBcfg.h have different module ids"
#endif
/* Check if current file and CDD_I2c_MBDT_PBcfg.h header file are of the same vendor */
#if (I2C_VENDOR_ID_CFG != I2C_MBDT_PBCFG_VENDOR_ID)
    #error "CDD_I2c_Cfg.h and CDD_I2c_MBDT_PBcfg.h have different vendor ids"
#endif
/* Check if current file and CDD_I2c_MBDT_PBcfg.h header file are of the same Autosar version */
#if ((I2C_AR_RELEASE_MAJOR_VERSION_CFG    != I2C_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (I2C_AR_RELEASE_MINOR_VERSION_CFG    != I2C_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (I2C_AR_RELEASE_REVISION_VERSION_CFG != I2C_MBDT_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of CDD_I2c_Cfg.h and CDD_I2c_MBDT_PBcfg.h are different"
#endif
/* Check if current file and CDD_I2c_MBDT_PBcfg.h header file are of the same Software version */
#if ((I2C_SW_MAJOR_VERSION_CFG != I2C_MBDT_PBCFG_SW_MAJOR_VERSION) || \
     (I2C_SW_MINOR_VERSION_CFG != I2C_MBDT_PBCFG_SW_MINOR_VERSION) || \
     (I2C_SW_PATCH_VERSION_CFG != I2C_MBDT_PBCFG_SW_PATCH_VERSION)    \
    )
