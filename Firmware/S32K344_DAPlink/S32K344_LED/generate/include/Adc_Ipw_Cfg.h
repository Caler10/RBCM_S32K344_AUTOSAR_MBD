...
#define ADC_IPW_AR_RELEASE_MINOR_VERSION_CFG       7
#define ADC_IPW_AR_RELEASE_REVISION_VERSION_CFG    0
#define ADC_IPW_SW_MAJOR_VERSION_CFG               4
#define ADC_IPW_SW_MINOR_VERSION_CFG               0
#define ADC_IPW_SW_PATCH_VERSION_CFG               0
...
/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_MBDT_PBcfg.h file are of the same vendor */
#if (ADC_IPW_VENDOR_ID_CFG != ADC_IPW_VENDOR_ID_MBDT_PBCFG)
    #error "Adc_Ipw_Cfg.h and Adc_Ipw_MBDT_PBcfg.h have different vendor ids"
#endif

/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_MBDT_PBcfg.h file are of the same Autosar version */
#if ((ADC_IPW_AR_RELEASE_MAJOR_VERSION_CFG != ADC_IPW_AR_RELEASE_MAJOR_VERSION_MBDT_PBCFG) || \
     (ADC_IPW_AR_RELEASE_MINOR_VERSION_CFG != ADC_IPW_AR_RELEASE_MINOR_VERSION_MBDT_PBCFG) || \
     (ADC_IPW_AR_RELEASE_REVISION_VERSION_CFG != ADC_IPW_AR_RELEASE_REVISION_VERSION_MBDT_PBCFG) \
    )
    #error "AutoSar Version Numbers of Adc_Ipw_Cfg.h and Adc_Ipw_MBDT_PBcfg.h are different"
#endif

/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_MBDT_PBcfg.h file are of the same Software version */
#if ((ADC_IPW_SW_MAJOR_VERSION_CFG != ADC_IPW_SW_MAJOR_VERSION_MBDT_PBCFG) || \
     (ADC_IPW_SW_MINOR_VERSION_CFG != ADC_IPW_SW_MINOR_VERSION_MBDT_PBCFG) || \
     (ADC_IPW_SW_PATCH_VERSION_CFG != ADC_IPW_SW_PATCH_VERSION_MBDT_PBCFG) \
    )
  #error "Software Version Numbers of Adc_Ipw_Cfg.h and Adc_Ipw_MBDT_PBcfg.h are different"
#endif
