...
#define TRGMUX_IP_MBDT_PBCFG_SW_MAJOR_VERSION_C              4
...
const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger0ConfigPB_MBDT =
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_0_TRIGGER_0,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_ADC12_0_EXTRG_NORMAL_CONV,
    /* uint8 Input; */          TRGMUX_IP_INPUT_LOGIC0_VSS,
