...
#define LPI2C_IP_MBDT_PBCFG_SW_MAJOR_VERSION_C              4
...
/* Check if current file and I2c header file are of the same Software version */
    ...
    #if ((LPI2C_IP_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION_C != MCAL_AR_RELEASE_MAJOR_VERSION) || \
         (LPI2C_IP_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION_C != MCAL_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Lpi2c_Ip_MBDT_PBcfg.c and Mcal.h are different"
    #endif
