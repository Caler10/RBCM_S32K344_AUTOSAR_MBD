...
#define FEE_SW_MAJOR_VERSION_CFG             5
...
#define FEE_MINIMUM_READ_PAGE_SIZE               (32U)

/* Job end notification routine provided by the upper layer module (declaration) */
/** @implements   FeeNvmJobEndNotification_Object */
#define FEE_NVM_JOB_END_NOTIFICATION_DECL        extern void MBDT_Fee_NvmJobEnd_Notification(void);

/* Job end notification routine provided by the upper layer module */
/** @implements   FeeNvmJobEndNotification_Object */
#define FEE_NVM_JOB_END_NOTIFICATION             MBDT_Fee_NvmJobEnd_Notification();
...
#define FEE_NVM_JOB_ERROR_NOTIFICATION_DECL      extern void MBDT_Fee_NvmJobError_Notification(void);

/* Job error notification routine provided by the upper layer module */
/** @implements   FeeNvmJobErrorNotification_Object */
#define FEE_NVM_JOB_ERROR_NOTIFICATION           MBDT_Fee_NvmJobError_Notification();

/* Job cluster format notification routine provided by the upper layer module (declaration) */
#define FEE_NVM_CLUSTER_FORMAT_NOTIFICATION_DECL extern void MBDT_Fee_ClusterFormatDuringInit_Notification(void);

/* Job cluster format notification routine provided by the upper layer module */
#define FEE_NVM_CLUSTER_FORMAT_NOTIFICATION      MBDT_Fee_ClusterFormatDuringInit_Notification();
