...
#include "Siul2_Port_Ip_MBDT_PBcfg.h"
...
/* Check if the files Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_MBDT_PBcfg.h are of the same version */
#if (SIUL2_PORT_IP_VENDOR_ID_CFG_H != SIUL2_PORT_IP_VENDOR_ID_MBDT_PBCFG_H)
    #error "Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_MBDT_PBcfg.h have different vendor IDs"
#endif
/* Check if the files Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_MBDT_PBcfg.h are of the same Autosar version */
#if ((SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_CFG_H != SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_MBDT_PBCFG_H) ||   \
     (SIUL2_PORT_IP_AR_RELEASE_MINOR_VERSION_CFG_H != SIUL2_PORT_IP_AR_RELEASE_MINOR_VERSION_MBDT_PBCFG_H) ||   \
     (SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_CFG_H != SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_MBDT_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_MBDT_PBcfg.h are different"
#endif
/* Check if the files Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_MBDT_PBcfg.h are of the same software version */
#if ((SIUL2_PORT_IP_SW_MAJOR_VERSION_CFG_H != SIUL2_PORT_IP_SW_MAJOR_VERSION_MBDT_PBCFG_H) || \
     (SIUL2_PORT_IP_SW_MINOR_VERSION_CFG_H != SIUL2_PORT_IP_SW_MINOR_VERSION_MBDT_PBCFG_H) || \
     (SIUL2_PORT_IP_SW_PATCH_VERSION_CFG_H != SIUL2_PORT_IP_SW_PATCH_VERSION_MBDT_PBCFG_H)     \
    )
    #error "Software Version Numbers of Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_MBDT_PBcfg.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
#define NUM_OF_CONFIGURED_PINS 114

#define PORT_START_SEC_CONFIG_DATA_UNSPECIFIED
#include "Port_MemMap.h"

SIUL2_PORT_CONFIG_MBDT_PB \
